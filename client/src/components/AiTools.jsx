  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            ...
            <p className='text-gray-500 mx-auto max-w-lg'>Everything you need to create, enhance, and optimize your content with cutting-edge AI technology.</p>
        </div>
        <div className='flex flex-wrap mt-10 justify-center'>
            {AiToolsData.map((tool,index)=>(
                ...
                transition-all duration-300 cursor-pointer' onClick={()=>user.isSignedIn ? navigate(tool.path):openSignIn()}>
                    ...
                    <h3 className='mt-6 mb-3 text-lg font-semibold text-slate-700'>{tool.title}</h3>
